...
namespace Orkestro\Bundle\ConfigBundle\Form;

use Orkestro\Bundle\CoreBundle\Form\AbstractTranslatableType;
use Symfony\Component\Form\FormBuilderInterface;
use Symfony\Component\OptionsResolver\OptionsResolverInterface;

class ConfigType extends AbstractTranslatableType
{
    /**
...
//            ->add('isoCode')
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Orkestro\Bundle\ConfigBundle\Model\Config'
        ));
    }
    ...
    {
        return 'orkestro_bundle_configbundle_config';
    }
}
