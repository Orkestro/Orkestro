...
class CountryController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('orkestro_backend_country_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/{id}", name="orkestro_backend_country_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrkestroCountryBundle:Country')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="orkestro_backend_country_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new CountryType(), $entity, array(
            'action' => $this->generateUrl('orkestro_backend_country_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="orkestro_backend_country_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('orkestro_backend_country_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="orkestro_backend_country_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('orkestro_backend_country_delete', array('id' => $id)))
            ->setMethod('DELETE')
